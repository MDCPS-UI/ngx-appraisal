 ...
 * @type: constant
 */
export const YA_PERSONAL_LIST: any[] = [
    {
        'label': 'What types of support do you hope to receive in the next six months? (Check all that apply)',
        'optionName': 'supportInNext6Months',
        'isCheckbox': true,
        'options': [
            {
                'label': 'Education',
